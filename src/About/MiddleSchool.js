            ...
            <ol className="carousel-indicators">
                ...
                <li data-target="#myCarousel" data-slide-to="5" className=""></li>
                   ...
                   {/* <blockquote className="custom-quote">
                    ...
                    <p><img className="img-responsive" src="http://zenopsys.net/soundarya_forms/central/images/Grade6_8part1.jpg" alt=""/>
                       <img className="img-responsive" src="http://zenopsys.net/soundarya_forms/central/images/Grade6_8part2.jpg" alt=""/>
                    </p>
