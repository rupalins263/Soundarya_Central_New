            ...
            <div  className="col-md-8">
                <div className="row"> 
                        ...
                        <div className="col-md-7 text-justify">						
                            <p style={{"font-size":"14px"}}>True education does not limit itself to grades and marks; instead it builds
                            the confidence in the child to embark on a never ending journey of
                            enquiry. Education equips a child to become a world citizen whose
                            horizon is the universe. A student thus educated with the universe in
                            mind is spurred to enhance the quality of life on the universe. Such a
                            child is empowered to bring dramatic changes which help in the very
                            evolution of mankind. Students geared to revolutionize the earth
                            perceive and achieve good results as mere by products of their larger
                            goal.</p>
                            <p style={{"font-size":"14px"}}>SCS has consistently been endeavoring for meaningful learning for its students.</p>
                            <p style={{"font-size":"14px"}}>It ascertains to provide an environment instrumental to creativity,
                            innovation and pioneering leadership to its students so that they are
                            prepared for the challenges of the contemporary world.</p>
                            <p style={{"font-size":"14px"}}>Soundarya Central School provides an environment that ignites talents
                            and skills from a very young age and the holistic curriculum brings
                            about an all round development in students and prepares them for global
                            citizenship.</p>
