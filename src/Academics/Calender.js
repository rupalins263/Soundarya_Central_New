							    ...
							    <div id="Feb" className="jtab-content jtab-selected conti" style={{"display": "block"}}>						        
							        <article className="events-item page-row has-divider clearfix">
										...
										<div className="details col-md-11 col-sm-10">
											<h3 className="title">School Sports Day</h3>                     
										</div>
									</article>
									...
									<article className="events-item page-row has-divider clearfix">
										...
										<div className="details col-md-11 col-sm-10">
											<h3 className="title">G K written Test</h3>                     
										</div>
									</article>
									...
									<article className="events-item page-row has-divider clearfix">
										...
										<div className="details col-md-11 col-sm-10">
											<h3 className="title">Preparatory III</h3>                     
										</div>
									</article>
									...
									<article className="events-item page-row has-divider clearfix">
										...
										<div className="details col-md-11 col-sm-10">
											<h3 className="title">Maha Shivarathri</h3>                     
										</div>
									</article>
									<article className="events-item page-row has-divider clearfix">
										<div className="date-label-wrapper col-md-1 col-sm-2">
									...
									<article className="events-item page-row has-divider clearfix">
										...
										<div className="details col-md-11 col-sm-10">
											<h3 className="title">Saraswathi Pooja</h3>                     
										</div>
									</article>
									<article className="events-item page-row has-divider clearfix">
										<div className="date-label-wrapper col-md-1 col-sm-2">
										...
										<div className="details col-md-11 col-sm-10">
											<h3 className="title">G K Quiz</h3>                     
										</div>
									</article>
									<article className="events-item page-row has-divider clearfix">
										<div className="date-label-wrapper col-md-1 col-sm-2">
										...
										<div className="details col-md-11 col-sm-10">
											<h3 className="title">Graduation Day</h3>                     
										</div>
									</article>
									<article className="events-item page-row has-divider clearfix">
										<div className="date-label-wrapper col-md-1 col-sm-2">
										...
										<div className="details col-md-11 col-sm-10">
											<h3 className="title">Moral Science Activity</h3>                     
										</div>
									</article>
									<article className="events-item page-row has-divider clearfix">
										<div className="date-label-wrapper col-md-1 col-sm-2">
